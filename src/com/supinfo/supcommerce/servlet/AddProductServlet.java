...
public class AddProductServlet extends HttpServlet {
	...
	private static final String	ERROR_NAME_REQ_ATT		= "error-name";
	private static final String	ERROR_CONTENT_REQ_ATT	= "error-content";
	private static final String	ERROR_PRICE_REQ_ATT		= "error-price";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		if (nameError == "" && contentError == "" && priceError == "") {
			...
			response.sendRedirect(request.getServletContext().getContextPath() + SHOW_PRODUCT_VIEW + "?" + ID_GET_PARAM
					+ "=" + product.getId());
		}
